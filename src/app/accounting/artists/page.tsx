                      ...
                      <div className="border-t border-[#e5dfd4]">
                        ...
                        <div className="border-t border-[#e5dfd4] px-5 py-4">
                          ...
                          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                            <div className="rounded-md border border-[#e5dfd4] p-3"><p className="text-xs font-bold text-[#697178]">Tattoo sales <InfoTip text="Tattoo amounts entered in Sessions during each month." /></p><BarChart data={artist.trend.map((month) => ({ label: month.label, value: month.tattoo }))} height={150} labelFontSize={12} valueFontSize={13} /></div>
                            <div className="rounded-md border border-[#e5dfd4] p-3"><p className="text-xs font-bold text-[#697178]">Tips <InfoTip text="Tip amounts entered during each month." /></p><BarChart color="#8a5130" data={artist.trend.map((month) => ({ label: month.label, value: month.tips }))} height={150} labelFontSize={12} valueFontSize={13} /></div>
                            <div className="rounded-md border border-[#e5dfd4] p-3"><p className="text-xs font-bold text-[#697178]">Sessions <InfoTip text="Number of completed Session accounting entries in each month." /></p><BarChart color="#476b33" data={artist.trend.map((month) => ({ label: month.label, value: month.sessions }))} height={150} labelFontSize={12} valueFontSize={13} valueFormatter={(value) => String(value)} /></div>
                            <div className="rounded-md border border-[#e5dfd4] p-3"><p className="text-xs font-bold text-[#697178]">Finalized payout <InfoTip text="Settlement amount from Ready or Paid Payout records, grouped by payout period end month." /></p><BarChart color="#775f36" data={artist.trend.map((month) => ({ label: month.label, value: month.payout }))} height={150} labelFontSize={12} valueFontSize={13} /></div>
                          </div>
                        </div>
